<?php namespace App\Http\Controllers;
	...
	class AdminClienteController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Ruc Ci","name"=>"ruc_ci"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Ruc Ci','name'=>'ruc_ci','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Ruc Ci","name"=>"ruc_ci","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
